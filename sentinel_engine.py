...
def get_pro_analysis(symbol):
    try:
        ...
        apds = [
            mpf.make_addplot(plot_df['EMA200'], color='#2962ff', width=1.5),
        ...
        return {
            ...
            "score": f"{score}/7", "weight": weight, "action": action, "plot": buf,
